...
public class CommitMessageTest {
    ...
    @Test
    public void testFormatCommit() throws IOException, InterruptedException {
    ...
    @Test
    public void testFormatCommit_withoutScope() throws IOException, InterruptedException {
    ...
    @Test
    public void testFormatCommit_withMultipleClosedIssues() throws IOException, InterruptedException {
    ...
    @Test
    public void testFormatCommit_withLongBreakingChange() throws IOException, InterruptedException {
    ...
    @Test
    public void testFormatCommit_addNumberSignIfMissing() throws IOException, InterruptedException {
        CommitMessage commitMessage = new CommitMessage(ChangeType.FEAT, "$route",
                "add support for the `reloadOnUrl` configuration option",
                "",
    ...
    @Test
    public void testFormatCommit_noWrap() throws IOException, InterruptedException {
        CommitMessage commitMessage = new CommitMessage(ChangeType.FEAT, null, "break everything", null,
    ...
    @Test
    public void testFormatCommit_skipCI() throws IOException, InterruptedException {
